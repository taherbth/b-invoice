...
<style>
    ...
    fieldset {
     ...
     <?php $sent_message = ""; if($num_of_sent_message){$sent_message = "(<span style='color:red;'>".$num_of_sent_message."</span>)";}?>
      <legend align="left"><?php echo anchor(base_url()."admin/info/communication_org", $this->lang->line('label_inbox').$inbox_message,"style='color:#FFFFFF;'"); ?> </legend>
     
      <?php echo anchor(base_url()."admin/info/compose_new_email", $this->lang->line('label_compose_new'));?>
      <?php echo "|&nbsp;".anchor(base_url()."admin/info/communication_org_email_sent", $this->lang->line('label_sent').$sent_message);?>
