...
<span>
    <span style="float:right;">
        <a href="<?php echo base_url().'organization/info/profile_setting_by_member/'.$p_info->mem_id;?>"> <button class="c"><?php echo $this->lang->line('mem_profile_settings_btn');?></button></a>
    </span>
    <span style="float:right;">
        <a href="<?php echo base_url().'organization/info/modify_my_profile/'.$p_info->mem_id;?>"> <button class="c"><?php echo $this->lang->line('mem_profile_edit_btn');?></button></a>
    </span>
</span>
</div>
