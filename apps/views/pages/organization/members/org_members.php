...
<?php echo $this->session->flashdata('message'); ?>
        ...
        <?php   echo '<a class="button add" href="'.base_url().'organization/info/create_new_member'.'">'.$this->lang->line('label_create_new').'</a>';  ?>
...
<div class="unit-25">
	<?php if($mem_type=="Admin"){ echo '<span class="is-admin">✓</span>Admin'; } else{ echo '<span style="color: #ccc;">Not admin</span>'; }?>
</div>
<div class="unit-push-right">
			<a class="button" href="<?php echo base_url(); ?>organization/info/profile_setting_by_admin/<?php echo $info->mem_id;?> ">Profile setting</a>
			<a class="button" href="<?php echo base_url(); ?>organization/info/modify_member_profile_by_admin/<?php echo $info->mem_id;?>">Edit</a>
			<?php   if($make_admin){
                if($mem_type=="Admin"){ echo'<a class="button" href="'.base_url()."organization/info/admin_previlize/".$info->mem_id, $this->lang->line('undo_admin').'">Toggle admin</a>';  }
				else{ echo '<a class="button" href="'.base_url()."organization/info/admin_previlize/".$info->mem_id, $this->lang->line('make_admin').'">Toggle admin</a>';  }
		        }
            ?>
	...
	<div class="accordion-content units-row">
        ...
        <div class="unit-33">
            <label class="From"><b>ID:</b> </label><?php echo $info->mem_id; ?><br>
                    ...
                    <span class="HighLight"><?php echo $info->first_name. "&nbsp;".$info->last_name; ?></span> <br>
        ...
        <div class="unit-33">
                    ...
                    <span class="HighLight"><?php echo $info->bank_acc_no_one; ?></span> <br>
                    <label class="From"><b>Bank Account Type:</b></label> 
                    <span class="HighLight"><?php echo $info->bank_acc_type_one; ?></span> <br>
                    
        </div>
        <div class="unit-33">
             <label class="From"><b>Person Number:</b></label> 
                    <span class="HighLight"><?php echo $info->ssn_or_person_no; ?></span> <br>
                    ...
                    <span class="HighLight"><?php echo $mem_type; ?></span> <br>
                    ...
                    <span class="HighLight"><?php if($member_ship_expire ){echo $member_ship_expire ;} else{echo "N/A";} ?></span> <br>
        </div>
	</div>
<?php endforeach; ?>
