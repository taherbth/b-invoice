...
<style>
    ...
    fieldset {
     ...
     <?php $inbox_sms= ""; if($num_of_inbox_sms){$inbox_sms = "(<span style='color:red;'>".$num_of_inbox_sms."</span>)";}?>
      <legend align="left"><?php echo anchor(base_url()."organization/info/communication_member_sms_sent", $this->lang->line('label_sent').$sent_sms,"style='color:#FFFFFF;'"); ?> </legend>
     
      <?php echo anchor(base_url()."organization/info/compose_new_sms", $this->lang->line('label_compose_new'));?>
      <?php echo "|&nbsp;".anchor(base_url()."organization/info/communication_member_sms", $this->lang->line('label_inbox').$inbox_sms);?>
<br/>
