...
<a class="button mail" href="<?php echo base_url()."organization/info/compose_new_email"; ?>"><?php echo $this->lang->line('label_compose_new'); ?></a>
	<h5 class="breadcrumb">
        ...
        <span class="<?php if($activeSubTab == 'draft') { echo 'active'; } ?>"><?php echo anchor(base_url()."organization/info/communication_member_email_draft", $this->lang->line('label_drafts').$draft_message); ?></span>
