...
<style>
	...
	<h5 class="breadcrumb">
		...
		<span class="<?php if($activeSubTab == 'draft') { echo 'active'; } ?>"><?php echo anchor(base_url()."organization/info/communication_member_sms_draft", $this->lang->line('label_drafts').$draft_sms); ?></span>
