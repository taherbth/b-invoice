<h3 class="content_edit"><?php echo $this->lang->line('article_post_msg'); ?> </h3>
...
<script>
    ...
    echo  form_open_multipart("organization/info/post_article_process",$attributes); ?>
        ...
        <table class="width-100">
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <?php echo form_dropdown('article_type',$article_type_option,'','class="form_input_select"');?>
