<h3 class="content_edit"><?php echo $this->lang->line('proposed_article_edit_msg');?></h2>
...
<script>
    ...
    echo  form_open_multipart("organization/info/edit_proposed_article_process",$attributes); ?>
    ...
    <div class="infobox" style="width: 900px; margin-bottom: 20px; font-size: 12px; -moz-border-radius: 8px 8px 8px 8px;">
        ...
        <table width="900" cellspacing="1" align="center" cellpadding="2" border="0" id="theBody" style="margin-left:40px; margin-top:10px">
            ...
            <div id="post_article_create_div" <?php if($post_article=="create_article"){?>style="display:''; margin-left:38px;" <?php } elseif($post_article=="" || $post_article=="upload_article" ){?>style="display:none; margin-left:38px;" <?php } ?>>                    
                ...
                <div style="margin-left:96px;float:left;"><?=form_input($article_color_code);?>
                ...
                <div id="post_article_upload_div" <?php if($post_article=="upload_article"){?>style="display:''; margin-left:38px; "  <?php } elseif($post_article=="" || $post_article=="create_article" ){?>style="display:none; margin-left:38px;" <?php } ?>>                    
                    ...
                    <span class="style1">*</span><br/>
                            <span><?php if($uploaded_article_val){ ?><a href="<?php echo base_url().'main_board_article/'. $uploaded_article_val; ?>" ><?php echo $uploaded_article_val;?> </a> <?php }  ?> </span>
                    </div>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td width="45%">
                        <?php    echo form_dropdown('article_type',$article_type_option,$article_type_val,'class="form_input_select"');?><span class="style1">*</span>
                ...
                <tr>
                    ...
                    <td width="45%">
                        ...
                        <?php $mainboard_sending_out= 0;  if($this->session->userdata('mem_type')=="Adminnnnnn" || $mainboard_sending_out) { echo $this->lang->line('label_article_send_by');?> <input type="checkbox" name="send_by" value="send_article_by" id="send_article" onClick="return display_article();"/>
                        <span class="style1"><?php echo $this->lang->line('label_or'); } 
                        $mainboard_send_notification =0; if($this->session->userdata('mem_type')=="Adminnnn" || $mainboard_send_notification) { ?></span> <?php echo $this->lang->line('label_notification_send_by');?> 
                ...
                <tr>
                    ...
                    <td width="45%">
                         <?=form_input($article_reminder_email_time); echo form_dropdown('article_reminder_email_time_unit',$article_reminder_email_time_unit,$article_reminder_email_time_unit_val,'class="form_input_select"');?>
                    </td>
                </tr>
                <tr>
                    <td style="text-align:left; padding-top:5px"></td>
        ...
        <table width="662" style="margin-top:10px" cellspacing="1" align="center" cellpadding="2" border="0" id="theBody">
            <tbody>
                ...
                <tr>
                    <td width="38%"><td width="33%">
                        <? // = form_hidden($article_id); ?>
                            <input name="article_id" value="<?php echo $article_id; ?>" class="form_normal" type="hidden">
