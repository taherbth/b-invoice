...
if(isset($_POST['last_time'])){
	$sql = "SELECT * FROM news WHERE date < '".$_POST['last_time']."' ORDER BY date DESC LIMIT 0, 5";
}
$resource = mysql_query($sql);
$news = array();
	...
	<div class="main_container">
		<div class="feeds_container">
			...
			<div id="feeds" class="feeds">
				...
				<div class="loading">
					<img src="<?php echo base_url(); ?>public/images/loading_transparent.gif"  alt=""/>
				</div>
			</div>
		</div>
		<div class="form">
