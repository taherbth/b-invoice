...
if($org_details){
    ...
    $org_primary_address = $org_details[0]->org_street_address;
    ...
    $org_phone = $org_details[0]->org_mobile_phone;
    $org_bank_acc_type_one = $org_details[0]->org_bank_acc_type_one;
    $org_bank_acc_no_one = $org_details[0]->org_bank_acc_no_one;
}
if($data_faktura['fak_active_date']){ $data_faktura['fak_active_date'] = date('Y-m-d',$data_faktura['fak_active_date']); } else{ $data_faktura['fak_active_date'] =  "Missing";}
if($data_faktura['fak_expire_date']){$data_faktura['fak_expire_date'] = date('Y-m-d',$data_faktura['fak_expire_date']); } else{ $data_faktura['fak_expire_date'] =  "Missing";}
$html ='<!DOCTYPE html>
<html>
<head>
    	...
    	<tr>
			...
			<td rowspan="2" valign="top" align="right" style="padding:3mm;">
				<table>
					...
					<tr><td>Fakturadatum : </td><td>'.$data_faktura['fak_active_date'].'</td></tr>
					<tr><td>Förfallodatum : </td><td>'.$data_faktura['fak_expire_date'].'</td></tr>
...
$mpdf->Output('custom_invoice/custom_invoice_'.$data_faktura['org_name'].'_'.$data_faktura['org_number'].'_'.$fak_insert_id.'.pdf','F');
