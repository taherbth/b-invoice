        ...
        if(isset($_POST['cancel'])){
            redirect('organization/info/non_ac_org_members');
                ...
                if($data_previlize['create_new_member']) {      
                    ...
                    $this->form_validation->set_rules('attention', $this->lang->line('label_attention'), 'trim|required|xss_clean');
                    
                    if($data_registration['email']){
                        $this->form_validation->set_rules('email', $this->lang->line('label_email'), 'trim|valid_email|xss_clean|callback_email_check');
                    }
                    if($data_registration['mobile_phone']){
 ...
 */ 
    function add_member_to_group($group_id = NULL) {        
        ...
        if( $data_previlize['members_add_group']) {  
            ...
            $this->data['all_non_ac_members'] = $this->info_model->get_org_non_ac_member($data_previlize['member_org']);
 ...
 */ 
	...
	$data_previlize = $this->check_member_type_previlize();
        ...
        if($data_previlize['mem_type']=="Admin" || $data_previlize['access_faktura']) {
 ...
 */ 
	...
	$data_previlize = $this->check_member_type_previlize();
        ...
        if($data_previlize['mem_type']=="Admin" || $data_previlize['access_faktura']) {
            $this->data['org_all_custom_invoice'] = $this->info_model->get_all_custom_invoice($data_previlize['member_org']);
 ...
 */ 
    function create_faktura(){
        ...
        if($data_previlize['mem_type']=="Superadmin" || $data_previlize['access_faktura']) {
            //$this->data['org_registered_member'] = $this->info_model->get_org_registered_member($data_previlize['member_org']);
            $this->data['org_registered_member'] = $this->info_model->view_all_faktura_customers($data_previlize['member_org']);
            $this->data['data_fak_settings_details'] = $this->info_model->get_faktura_settings($org_id);  
 ...
 */ 
	...
	$data_previlize = $this->check_member_type_previlize();
        ...
        $mem_id = $this->session->userdata('mem_id');        
        $this->data['org_registered_member'] = $this->info_model->get_org_registered_member($data_previlize['member_org']);
        $this->data['faktura_customers'] = $this->info_model->view_all_faktura_customers($data_previlize['member_org']);
        $this->data['data_fak_settings_details'] = $this->info_model->get_faktura_settings($org_id);            
        $this->data['data_fak_products'] = $this->info_model->view_all_faktura_products($org_id);     
        $fak_invoice_no = $this->input->post('fak_invoice_no');
                    ...
                    if($data_create_faktura['fak_send_to_org_customer']){
                        $this->data['faktura_org_customer_details'] = $this->info_model->get_member_info_by_id($data_create_faktura['fak_send_to_org_customer'], $org_id);
                         if($this->data['faktura_org_customer_details'] ) {
                            ...
                            $data_faktura['bill_primary_address'] = $this->data['faktura_org_customer_details'][0]->street_address;
                            $data_faktura['bill_city'] = $this->data['faktura_org_customer_details'][0]->city;
                            $data_faktura['bill_phone'] = $this->data['faktura_org_customer_details'][0]->mobile_phone;
 ...
 */
 function custom_invoice_send(){
   ...
   ///////////////////////////////////////////////////////////
   if($data_previlize['mem_type']=="SuperAdmin" || $data_previlize['mem_type']=="Admin" || $data_previlize['access_faktura']) {            $package_info = "";
            ...
            if($org_info){
                ...
                $data['org_primary_address'] = $org_info[0]->org_street_address;
                $data['org_phone'] = $org_info[0]->org_mobile_phone;
                $data['org_email'] = $org_info[0]->org_email;
            ...
            if($get_client_info && !empty($data_faktura['fak_send_to_org_customer'])){                    
                ...
                $data_faktura['primary_address'] = $get_client_info[0]->street_address;                    
                ...
                $data_faktura['fak_customer_contact_no'] = $get_client_info[0]->mobile_phone;
            ...
            if($data['send_invoice_letter'] =="letter"){
                ...
                //$data_faktura['price_total_exclusive_vat']= $price_total_exclusive_vat;   
                $this->edit_custom_invoice($data_faktura,$custom_faktura_id,$data,$org_id);
...
function edit_custom_invoice($data_faktura,$custom_faktura_id,$data, $member_org){   
    include("MPDF/mpdf.php");
    $product_name = array();
    $no_of_products = array();
    $price_ex_vat = array();
    $vat_rate = array();    
    $data_fak_settings_details = $this->info_model->get_faktura_settings( $member_org );
    ...
    /****************************** Edit  Faktura Here ***************************************/
        ...
        $org_details =  $this->info_model->get_organization_info_by_id($member_org);
        $custom_faktura_assigned_product_info = $this->info_model->get_custom_faktura_assigned_product($custom_faktura_id);
        if($custom_faktura_assigned_product_info){
            foreach($custom_faktura_assigned_product_info as $rows){
                $product_name[$index] = $rows->product_name;
...
function send_custom_invoice_by_email($data,$content,$file_name, $data_faktura){ echo $data['email']; 
    $this->lang->load('common', $this->session->userdata('lang_file'));                
 ...
 */
    function communication_member() {
        ...
        $this->data['num_of_draft_message'] = "";    
        $this->data['num_of_upcoming_message'] = "";    
        $member_group_id = "";
        $data_previlize = $this->check_member_type_previlize();
        $mem_id = $this->session->userdata('mem_id');
        $mem_type = $data_previlize['mem_type']; 
        ...
        //print_r($this->data['num_of_inbox_message']); exit;
        $this->data['num_of_sent_message'] = $this->info_model->get_member_communicate_member_message($flag="sent", $mem_id, "", "");
        $this->data['num_of_draft_message'] = $this->info_model->get_member_communicate_member_message($flag="draft", $mem_id, "", "");
        $this->data['num_of_upcoming_message'] = $this->info_model->get_member_communicate_member_message($flag="draft", $mem_id, "", "");
        ////////////////////////////////////
        @$start = $this->uri->segment(4);
        //print_r($start);
        // Number of record showing per page
...
function compose_new_email(){
    ...
    $this->data['all_active_members'] = $this->info_model->get_org_active_member($data_previlize['member_org']);
    $this->data['all_non_ac_members'] = $this->info_model->get_org_non_ac_member($data_previlize['member_org']);
    ...
    //print_r($this->data['mem_assigned_group_info']); exit;    
...
function compose_new_email_process(){
    ...
    $this->data['send_option'] = 'send_now';
    $group_mem_id  = "";
    $send_to_member_list_id = "";
    $send_to_member = array();     
    $send_every_body = array();
    $send_to_admin_member = array();    
    ...
    $this->data['send_every_body'] = $this->input->post('send_every_body');       
    $this->data['send_to_member'] = $this->input->post('send_to_member');
    ...
    if(empty($this->data['individual_email_addresses'][0]) && empty($this->data['send_every_body']) && empty($this->data['send_to_member']) && empty($this->data['send_to_admin_member']) ){
        $this->form_validation->set_rules('send_to_member', $this->lang->line('label_send_to'), 'trim|required');
    }
    $send_to_member = $this->data['send_to_member'];
    $send_every_body = $this->data['send_every_body'];
    $send_to_admin_member = $this->data['send_to_admin_member'];    
    $send_to_member = array_merge((array)$send_to_member, (array)$send_every_body);
    $send_to_member = array_unique(array_filter(array_merge((array)$send_to_member, (array)$send_to_admin_member)));
    $send_to_member = array_values($send_to_member);
        
    if(sizeof($send_to_member)==1){
        $send_to_member_list_id = $send_to_member[0];
    }elseif(sizeof($send_to_member)>1){
        $send_to_member_list_id = implode(",",$send_to_member);                
    }                                        
    if($send_to_member_list_id){$email_data['send_to_member'] =  ",".$send_to_member_list_id.",";}        
   ...
   /////////////////////////////////////////////////////////
         if ($this->form_validation->run() == FALSE) { 
            ...
            $this->_commonPageLayout('frontend_viewer');
                    ...
                    if($send_to_member_list_id){
                        //$send_to_member_list_id = ",".$send_to_member_list_id.",";
                        $send_member_info = $this->info_model->get_member_info_by_id_for_communication($send_to_member_list_id);
                        if($send_member_info){
                            foreach($send_member_info as $rows){
                                array_push($email_addresses, $rows->email);
                                if($rows->non_ac_member){
                                        array_push($members_name, $rows->attention);
                                }else{ array_push($members_name, $rows->first_name." ".$rows->last_name); }
                            }
                        }
                    } 
...
/**
 * Communication with organization : Show Draft E-mail
 *
 *@access private
 *@return Draft E-mail View
 */
    function communication_member_email_draft() {
        $this->lang->load('common', $this->session->userdata('lang_file'));
        $this->data['mainTab'] = 'communication';
        $this->data['activeTab'] = 'email';    
        $this->data['activeSubTab'] = 'draft';    
        $member_group_id = "";
        $data_previlize = $this->check_member_type_previlize();
        $mem_id = $this->session->userdata('mem_id');
        $mem_type = $data_previlize['mem_type']; 
        ...
        // Get all users
        // Pagination config
        $this->p_config['base_url'] = site_url("organization/info/communication_member_email_draft");
        $this->p_config['uri_segment'] = 4;
        $this->p_config['num_links'] = 2;
        $this->p_config['total_rows'] = $this->info_model->get_member_communicate_sent_message("","", $mem_id)->num_rows();
        //print_r($this->p_config['total_rows']);die();
        ...
        $this->data['dynamicView'] = 'pages/organization/communication_member/email_draft';
        $this->_commonPageLayout('frontend_viewer');
}


/**
 * Communication with organization : Show Upcoming E-mail
 *
 *@access private
 *@return Upcoming E-mail View
 */
    function communication_member_email_upcoming() {
        $this->lang->load('common', $this->session->userdata('lang_file'));
        $this->data['mainTab'] = 'communication';
        $this->data['activeTab'] = 'email';    
        $this->data['activeSubTab'] = 'sent';    
        ...
        // Get all users
        // Pagination config
        $this->p_config['base_url'] = site_url("organization/info/communication_member_email_upcoming");
        $this->p_config['uri_segment'] = 4;
        $this->p_config['num_links'] = 2;
        $this->p_config['total_rows'] = $this->info_model->get_member_communicate_sent_message("","", $mem_id)->num_rows();
        //print_r($this->p_config['total_rows']);die();
 ...
 */
function read_member_comm_member_inbox_email_message($id) {
        $this->lang->load('common', $this->session->userdata('lang_file'));
        $this->data['mainTab'] = 'communication';
        $this->data['activeTab'] = 'email';
        $member_group_id = "";
        ...
        $this->data['dynamicView'] = 'pages/organization/communication_member/email_message_inbox_view';
        $this->_commonPageLayout('frontend_viewer');
    }
 ...
 *@return E-mail message Details
 */
function read_member_comm_member_sent_email_message($id) {
        $this->lang->load('common', $this->session->userdata('lang_file'));
        $this->data['mainTab'] = 'communication';
        $this->data['activeTab'] = 'email';
        $this->data['activeSubTab'] = 'sent';    
        ...
        $this->info_model->member_comm_member_email_status_update($data, $id);
        $this->data['message'] = $this->info_model->get_email_message_detail($id);
        $this->data['dynamicView'] = 'pages/organization/communication_member/email_message_sent_view';
        $this->_commonPageLayout('frontend_viewer');
    }
/**
...
function reply_email_message_process(){
    ...
    /////////////////////////////////////////////////////////////
     if($this->data['query1']) {
            $this->data['sender_name'] = $this->data['query1'][0]->first_name." ".$this->data['query1'][0]->last_name;
    }
    $this->data['email_sender'] = $mem_id;
    $this->data['email_subject'] = $this->input->post('email_subject');
    $this->data['email_message'] = $this->input->post('email_message');
    ...
    if($send_to_member_list_id){$email_data['send_to_member'] =  ",".$send_to_member_list_id.",".$receiver_id.",";}                   
    if($this->data['send_option']=="send_later"){
        $this->form_validation->set_rules('sending_date', $this->lang->line('label_select_date'), 'trim|required');
        $this->form_validation->set_rules('sending_hour_option', $this->lang->line('label_time'), 'trim|required');
    }
 ...
 */
    function communication_member_sms() {
        ...
        $this->data['num_of_draft_sms'] = "";
        $this->data['num_of_upcoming_sms'] = "";
        $member_group_id = "";
        $data_previlize = $this->check_member_type_previlize();
        $mem_id = $this->session->userdata('mem_id');
        $mem_type = $data_previlize['mem_type']; 
        ...
        if($check_pacakge_access['sms_module_access']){
            ...
            $this->data['num_of_draft_sms'] = $this->info_model->get_member_communicate_member_sms($flag="draft" , $mem_id, $member_group_id, $mem_type);
            $this->data['num_of_upcoming_sms'] = $this->info_model->get_member_communicate_member_sms($flag="upcoming" , $mem_id, $member_group_id, $mem_type);
            ////////////////////////////////////
            @$start = $this->uri->segment(4);
            //print_r($start);
            // Number of record showing per page
...
function compose_new_sms(){
    ...
    if($check_pacakge_access['sms_module_access']){
        ...
        //$this->data['active_org_list'] = $this->info_model->get_registered_customer($org_id="");
        $this->data['num_of_inbox_sms'] = $this->info_model->get_member_communicate_member_sms($flag="inbox", $mem_id, $member_group_id, $mem_type);
        $this->data['num_of_sent_sms'] = $this->info_model->get_member_communicate_member_sms($flag="sent", $mem_id, "", "");
        $this->data['num_of_draft_sms'] = $this->info_model->get_member_communicate_member_sms($flag="draft", $mem_id, "", "");
        $this->data['num_of_upcoming_sms'] = $this->info_model->get_member_communicate_member_sms($flag="upcoming", $mem_id, "", "");
...
function compose_new_sms_process(){
    ...
    if($check_pacakge_access['sms_module_access']){   
        ...
        $this->data['num_of_draft_message'] = $this->info_model->get_member_communicate_member_sms($flag="draft", $mem_id, "", "");
        $this->data['all_active_members'] = $this->info_model->get_org_active_member($data_previlize['member_org']);
        $this->data['all_non_ac_members'] = $this->info_model->get_org_non_ac_member($data_previlize['member_org']);
        $this->data['mem_assigned_group_info'] = $this->info_model->get_mem_group_member_info($mem_id, $data_previlize['member_org']);    
        $this->data['all_active_admin'] = $this->info_model->get_org_active_admin($data_previlize['member_org']);            
 ...
 */
  function read_member_comm_member_sms_message($id) {
        ...
        $this->data['num_of_draft_sms'] = $this->info_model->get_member_communicate_member_sms($flag="draft", $mem_id, $member_group, $mem_type);
        $this->data['num_of_upcoming_sms'] = $this->info_model->get_member_communicate_member_sms($flag="upcoming", $mem_id, $member_group, $mem_type);
...
/**
 * Communication with Member Via SMS: Show Draft SMS
 *
 *@access private
 *@return SMS Draft view
 */
    function communication_member_sms_draft() {
        $this->lang->load('common', $this->session->userdata('lang_file'));        
        $this->data['mainTab'] = 'communication';
        $this->data['activeTab'] = 'sms';
        $this->data['activeSubTab'] = 'draft';  
        ...
        // Get all users
        // Pagination config
        $this->p_config['base_url'] = site_url("admin/info/communication_org_sms_draft");
        $this->p_config['uri_segment'] = 4;
        $this->p_config['num_links'] = 2;
        $this->p_config['total_rows'] = $this->info_model->get_member_communicate_sent_sms("","", $mem_id)->num_rows();
        //print_r($this->p_config['total_rows']);die();
        ...
        $this->pagination->initialize($this->p_config);
        ///////////////////////////////////
        $this->data['dynamicView'] = 'pages/organization/communication_member/sms_draft';
        $this->_commonPageLayout('frontend_viewer');
 ...
 *@return SMS Draft view
 */
    function communication_member_sms_upcoming() {
        $this->lang->load('common', $this->session->userdata('lang_file'));        
        $this->data['mainTab'] = 'communication';
        $this->data['activeTab'] = 'sms';
        $this->data['activeSubTab'] = 'upcoming';  
        $member_group_id = "";
        $data_previlize = $this->check_member_type_previlize();
        $mem_id = $this->session->userdata('mem_id');
        $mem_type = $data_previlize['mem_type']; 
        ...
        // Get all users
        // Pagination config
        $this->p_config['base_url'] = site_url("admin/info/communication_member_sms_upcoming");
        $this->p_config['uri_segment'] = 4;
        $this->p_config['num_links'] = 2;
        $this->p_config['total_rows'] = $this->info_model->get_member_communicate_sent_sms("","", $mem_id)->num_rows();
        //print_r($this->p_config['total_rows']);die();
        ...
        $this->pagination->initialize($this->p_config);
        ///////////////////////////////////
        $this->data['dynamicView'] = 'pages/organization/communication_member/sms_upcoming';
        $this->_commonPageLayout('frontend_viewer');
