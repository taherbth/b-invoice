    ...
    <table class="heading" style="width:100%;">
    	<tr>
			...
			<td rowspan="2" valign="top" align="right" style="padding:3mm;">
				<table>
					<tr><td>Faktura Nummer  : </td><td>'.$fak_id.'</td></tr>
	...
	<div id="content">
		...
		<div id="invoice_body">
			...
			<tr>
             ...
             $si_no = 1; 
             $html2 = "";            
             if($data_faktura['total_sms_sent'] > 0){      
                $si_no = $si_no+1;
                $html2 .= '<tr>
			    <td style="width:8%;">'.$si_no.'</td>
			    <td style="text-align:left; padding-left:10px;">SMS</td>
			    <td class="mono" style="width:15%;">'.$data_faktura['total_sms_sent'].'</td>
                <td style="width:15%;" class="mono">'.$data_faktura['sms_unit_price'].'</td>
			    <td style="width:15%;" class="mono">'.$data_faktura['fak_sms_cost'].'</td>
			    <td style="width:15%;" class="mono">'.$data_faktura['fak_vat_rate'].'%</td>
			   </tr>';	
            }
            $html .= $html2;    
            $html3 = "";            
             if($data_faktura['total_letter_sent'] > 0){    
                $si_no = $si_no+1;
                $html3 .= '<tr>
			    <td style="width:8%;">'.$si_no.'</td>
			    <td style="text-align:left; padding-left:10px;">Letter</td>
			    <td class="mono" style="width:15%;">'.$data_faktura['total_letter_sent'].'</td>
                <td style="width:15%;" class="mono">'.$data_faktura['letter_unit_price'].'</td>
			    <td style="width:15%;" class="mono">'.$data_faktura['fak_letter_cost'].'</td>
			    <td style="width:15%;" class="mono">'.$data_faktura['fak_vat_rate'].'%</td>
                </tr>';
            }            
            $html .= $html3;    
            $html4 = "";            
            if($data_faktura['invoice_sent_by_letter_cost'] > 0){       
                $si_no = $si_no+1;
                $html4 .= '<tr>
                    <td style="width:8%;">'.$si_no.'</td>
                    <td style="text-align:left; padding-left:10px;">Invoice Cost</td>
                    <td class="mono" style="width:15%;">'.$data_faktura['no_of_fak_invoice_sent_by_letter'].'</td>
                    <td style="width:15%;" class="mono">'.$data_faktura['fak_invoice_cost_applied'].'</td>
                    <td style="width:15%;" class="mono">'.$data_faktura['invoice_sent_by_letter_cost'].'</td>
                    <td style="width:15%;" class="mono">'.$data_faktura['fak_vat_rate'].'%</td>
                </tr>';
            }
        ...
        <table>
			...
			<tr>
			    ...
			    <td style="width:8%;">'.$data_faktura['price_total_exclusive_vat'].'</td>
...
$mpdf->Output('invoice/invoice_'.$data_faktura['org_name'].'_'.$data_faktura['org_number'].'_'.$fak_id.'.pdf','F');
