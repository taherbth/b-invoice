    ...
    <table class="heading" style="width:100%;">
    	...
    	<tr>
    		<td>
    			...
    			<b>Address</b> : '.$data_faktura['org_name'].' <br /> '.$data_faktura['bill_street_address'].
                '<br /> '.$data_faktura['bill_city'].' <br /> Mob: &nbsp;'.$data_faktura['bill_mobile_phone']
	...
	<div id="content">
		...
		<div id="invoice_body">
			...
			<tr style="background:#eee;">
			 ...
			 $html1 = ""; 
            if($data_faktura['used_module_price']){ $si_no = 0;
                foreach($data_faktura['used_module_price'] as $key=>$value){
                    $si_no = $si_no + 1; 
                $html .='<tr>
			    <td style="width:8%;">'.$si_no.'</td>
			    <td style="text-align:left; padding-left:10px;">'.$key.'</td>
			    <td class="mono" style="width:15%;">1</td>
                <td style="width:15%;" class="mono">'.$value.'</td>
			    <td style="width:15%;" class="mono">'.$value.'</td>
             ...
             $html2 = "";            
            if($data_faktura['fak_invoice_cost']){            
                    $html2 .= '<tr>
                    <td style="width:8%;">2</td>
                    <td style="text-align:left; padding-left:10px;">Invoice Cost</td>
                    <td class="mono" style="width:15%;">1</td>
                    <td style="width:15%;" class="mono">'.$data_faktura['fak_invoice_cost'].'</td>
                    <td style="width:15%;" class="mono">'.$data_faktura['fak_invoice_cost'].'</td>
                    <td style="width:15%;" class="mono">'.$data_faktura['fak_vat_rate'].'%</td>
                </tr>';		
             }            
...
$mpdf->Output('invoice/invoice_'.$data_faktura['org_name'].'_'.$data['org_number'].'_'.$fak_insert_id.'.pdf','F');
